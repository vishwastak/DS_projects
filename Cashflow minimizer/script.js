...
onload = function(){
    ...
    //initialise graph options according to vis.js
    const options = {
        edges: {
            arrows: {
                to: true
    ...
    function createData(){
        ...
        //creating random edges between the nodes
        const edges = [];
        for(let i=1;i<=sz;i++){
    ...
    function solveData(){
        ...
        //initialise a new array with all values 0 
